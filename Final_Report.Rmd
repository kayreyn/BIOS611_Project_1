...
The variables resting electrocardiographic results, thalium, and peak exercise ST segment slope all have one category that has very small counts. This could result in an overfitted model because these categories will be underrepresented.  Thalium and chest pain type seem to have the most dramatic differences in counts, potentially indicating their future weight in predictive models. 
