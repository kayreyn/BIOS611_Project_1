...
The bar graphs displayed below make it easy to visualize the frequency of the levels of discrete variables in the data.  Fluoroscopy and thallium tests measure blood flow to the heart.  An electrocardiogram measures heart functionality to detect previous heart conditions and irregular heart beat [4]. Exercise induced angina simply refers to whether a patient experienced chest pain during exercise. 
